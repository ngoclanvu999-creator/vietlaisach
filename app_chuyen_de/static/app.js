/**
 * Giao diện app SOẠN CHUYÊN ĐỀ.
 *
 * Viết mới chứ không chép rồi cắt từ giao diện cũ (2.043 dòng, phục vụ chín
 * loại đầu ra). App này chỉ có HAI loại nên bước "chọn một trong chín" biến
 * mất, kéo theo hàng loạt nhánh điều kiện không còn cần nữa.
 *
...
(function () {
    ...
    // ======================================================================
    // BƯỚC 2 — mô tả loại đầu ra
    // ======================================================================
    const MO_TA = {
        CHUYEN_DE_BT:
            "Bốn phần: lý thuyết kèm ví dụ · bài tập tự luyện ba mức độ · "
            + "câu hỏi từ đề thi · hướng dẫn và đáp án dồn về cuối.",
        TAI_LIEU_HSG:
            "Chia theo 13 chuyên đề đo từ 13 đề HSG thật. Ba mức Vận dụng / "
            + "Vận dụng cao / Olympic, giấu phương án, lời giải trình bày đầy đủ.",
    };
    $("loai-dau-ra").addEventListener("change", (e) => {
        $("mo-ta-loai").textContent = MO_TA[e.target.value] || "";
    });
